...
- clone the repo: `git clone git@github.com:abogoyavlensky/k3s-provision.git` ot just copy the [`main.tf`](https://github.com/abogoyavlensky/k3s-provision/blob/0.1.0-article/main.tf) file;
